...
```bash
wget -N --no-check-certificate "https://github.com/philipfan01/Trojan_panel_web/raw/master/trojan-web-panel.sh" && chmod +x trojan-web-panel.sh && ./trojan-web-panel.sh
```
